...
b = np.array([(1, 2, 3, 4), (4, 3, 2, 1)])  # OR b = np.array([[1, 2, 3, 4], [4, 3, 2, 1]])
print(f'MULTIDEMENSIONAL: {b}')
print(b.shape)  # (2, 4) Row X Column
...
# Random array (ie 2 by 3, values range from 0 to 1)
x = np.random.rand(2,3)
print(x)

# Fille a m X n matrix with z values (ie 2 by 3 values all filled with 440). If ones, can use np.ones(2,3),
# or np.zeros(2,3) if zeros
y = np.full((2,3), 440)
print(y)
