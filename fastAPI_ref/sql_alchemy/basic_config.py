...
6. ORM functionality; create db_user.py file
7. API functionality; Create user.py file


FastAPI works with any relational database
ORM - Object Relational Mapping: Convertion from Python Class to Database model
